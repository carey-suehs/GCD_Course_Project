...
This project contain the following elements:
     ...
     3. Two txt files corresponding to datasets generated by the R script.
     4. A codebook document providing information for variables in the txt files.
...
The resulting tidy dataset is exported to the working directory as "averages_persubject_peractivity.txt".
